...
VALUES
    (N'Nguyễn Ngọc Ngà',      '0901111111', N'HCM', 'ngngaplbl@gmail.com',          N'QUAN_LY',       15000000, 1, '$2a$10$slYQmyNdgTY18LGvgxPwHOIXbe8eX34VnFaqGFPvUZE8N.fFZRuJa'),
    (N'Trần Thảo Nương',      '0902222222', N'HCM', 'nuong@gmail.com',         N'KY_THUAT_VIEN', 12000000, 1, '$2a$10$slYQmyNdgTY18LGvgxPwHOIXbe8eX34VnFaqGFPvUZE8N.fFZRuJa'),
    (N'Phạm Ngọc Tú',         '0903333333', N'HCM', 'ngoctus@gmail.com',       N'KY_THUAT_VIEN', 12000000, 1, '$2a$10$slYQmyNdgTY18LGvgxPwHOIXbe8eX34VnFaqGFPvUZE8N.fFZRuJa'),
    (N'Trần Minh Tú',         '0904444444', N'HCM', 'minhtu94@gmail.com',      N'NGUOI_DUNG',     9000000, 1, '$2a$10$slYQmyNdgTY18LGvgxPwHOIXbe8eX34VnFaqGFPvUZE8N.fFZRuJa'),
    (N'Admin',     '0905555555', N'HCM', 'admin@example.com',       N'Quản lý',       10000000, 1, '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy'),
    (N'Nguyễn Thị Hương',     '0909999999', N'HCM', 'chuquan@example.com',     N'Chủ quán',      25000000, 1, '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy'),
    (N'Trần Thảo Nương (PH)', '0922000000', NULL,   'admin1@example.com',      N'Quản lý',         800000, 1, '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy'),
    (N'Phạm Ngọc Tú (PH)',    '0933000000', NULL,   'admin2@example.com',      N'Quản lý',         800000, 1, '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy'),
    (N'Trần Minh Tú (PH)',    '0944000000', NULL,   'admin3@example.com',      N'Quản lý',         800000, 1, '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy');
GO
...
VALUES
    (N'Giảm 10% cuối tuần',      N'PHAN_TRAM', 10,    '2025-01-01', '2026-12-31', N'Giảm 10% cho đơn hàng cuối tuần'),
    (N'Tặng 50k đơn trên 300k',  N'SO_TIEN',   50000, '2025-05-01', '2026-06-30', N'Tặng 50k cho đơn từ 300k'),
    (N'Ưu đãi thành viên Vàng',  N'PHAN_TRAM', 15,    '2025-01-01', '2026-12-31', N'Giảm 15% cho hội viên Vàng');
GO
